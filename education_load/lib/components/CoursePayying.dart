...
//支付密码  +  自定义键盘
class CoursePayying extends StatefulWidget {
  static final String sName = "enter";

  @override
  State<StatefulWidget> createState() {
    return new CoursePayyingState();
  }
}

class CoursePayyingState extends State<CoursePayying> {
  /// 用户输入的密码
  String pwdData = '';
            ...
            actions: <Widget>[
              new FlatButton(
                ...
                onPressed: ()=>Navigator.pushAndRemoveUntil(context,
                    new MaterialPageRoute(builder: (context) => new IndexPage(pageIndex: 0,),),
                        (route)=>route==null)
              ),
            ],
          );
